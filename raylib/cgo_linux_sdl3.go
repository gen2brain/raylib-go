//go:build linux && sdl3 && !rgfw && !drm && !android
// +build linux,sdl3,!rgfw,!drm,!android
...
#cgo linux,sdl3 CFLAGS: -DPLATFORM_DESKTOP_SDL -DPLATFORM_DESKTOP_SDL3 -DUSING_SDL3_PACKAGE
